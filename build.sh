...
java -classpath ./deps/scala-compiler-2.10.0.jar:./deps/scala-libary-2.10.0.jar -Xbootclasspath/a:./deps/scala-library-2.10.0.jar:./deps/scala-compiler-2.10.0.jar:./deps/scala-reflect-2.10.0.jar scala.tools.nsc.Main -d bin/java -classpath ./deps/scala-compiler-2.10.0.jar:./deps/scala-swing-2.10.0.jar:./deps/scala-library-2.10.0.jar src/java/**/*.scala
